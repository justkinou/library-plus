...
function HowDoWeOperateSecton() {
  ...
  return (
    <div className="w-full p-12 flex flex-col justify-center items-center gap-4 overflow-hidden bg-[url(/images/howDoWeOperateSectionBackground.jpg)] bg-center bg-no-repeat bg-cover bg-fixed">
      <span className="text-xl md:text-3xl text-light font-bold">How dow we operate?</span>
      ...
      <div className="flex flex-col md:flex-row w-full justify-between items-center gap-6 md:gap-0">
        ...
        <InformationCard
          ...
          icon={<ArrowsClockwiseIcon size={64} />}
        />
      </div>
    </div>
  )
